...
// yg didalam () isinya bebas yg penting ssama kaya return, (el) artinya years karena var ages = arraycalc(years,calculate Age), kalo fullAges(el) artinya ages karena var fullAges = arraycalc(ages, fullAges);
...
var ages = arraycalc(years, calculateAge);
var fullJapan = arraycalc(ages, fullAges.bind(this, 20));
